...
class _FormRegistrationState extends State<FormRegistration> {
  ...
  Widget build(BuildContext context) {
    ...
    controller.entrance_fee.text = "20.00";
    controller.monthly_fee.text = "5.00";
    return Form(
      key: _key,
      child: Scaffold(
        appBar: AppBar(
            ...
            Column(
              ...
              children: [
                ...
                CustomFormField(
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        ...
                        return 'Please enter valid Email/Emel';
                      }
                      return null;
                    },
                ...
                CustomFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Please enter your Date Of Employment';
                      }
