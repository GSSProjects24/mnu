...
import 'view/auth/landing-page.dart';

class TermsAndCondtion extends StatefulWidget {
  const TermsAndCondtion({super.key});

  @override
  State<TermsAndCondtion> createState() => TermsAndCondtionState();
}

class TermsAndCondtionState extends State<TermsAndCondtion> {
  @override
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Text(
                        "MNU (We , Our, or Us) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by MNU.This Privacy Policy applies to our application named MNU, and its associated subdomains (collectively, our Service). By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.",
  ...
  •	Company: When this policy mentions Company.  We, Us or Our, it refers to MNU that is responsible for your information under this Privacy Policy.
  •	Country: Where MNU or the owners/founders of MNU are based in this case is Malaysia
  •	Customer: Refers to the company, organization or person that signs up to use the MNU Service to manage the relationships with your consumers or service users.
  •	Device: Any internet connected device such as a phone, tablet computer or any other device that can be used to visit MNU and use the services.
  •	IP address: Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.
  •	Personnel: Refers to those individuals who are employed by MNU or are under contract to perform a service on behalf of one of the parties.
  •	Personal Data: Any information that directly indirectly on in connection with other information - including a personal identification number- allows for the identification or identifiability of a natural person.
  •	Service: Refers to the service provided by MNU as described in the relative terms (it available) and on this platform.
  •	Third-party service: Refers to advertisers contest sponsors promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.
  •	Website: MNU's site. Which can be accessed via this URL
  •	You: A person or entity that is registered with MNU to use the Services. ''',
                      textAlign: TextAlign.justify,
                    ),
                    const SizedBox(
                      height: 5,
...
The laws of Malaysia, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.
                            ...
                            child: ElevatedButton(
                              style: ButtonStyle(
                                  maximumSize: MaterialStateProperty.all(Size(
                                      Get.width * 0.60, Get.height * 0.06)),
